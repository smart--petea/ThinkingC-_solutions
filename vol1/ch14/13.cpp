/*
 * In SynthesizedFunctions.cpp modify Chess to give it a 
...
class Chess : public Game 
{
    public:
        ...
        Chess(Chess const& x) : Game(x) {}

        Chess& operator=(Chess const& c)
        {
            Game::operator=(c);
